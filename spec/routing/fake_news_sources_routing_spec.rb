...
RSpec.describe FakeNewsSourcesController, type: :routing do
  describe "routing" do
    ...
    it "routes to #edit" do
      expect(:get => "/fake_news_sources/1/edit").to route_to("fake_news_sources#edit", :id => "1")
    end
    ...
    it "routes to #update via PUT" do
      expect(:put => "/fake_news_sources/1").to route_to("fake_news_sources#update", :id => "1")
    end

    it "routes to #update via PATCH" do
      expect(:patch => "/fake_news_sources/1").to route_to("fake_news_sources#update", :id => "1")
    end
